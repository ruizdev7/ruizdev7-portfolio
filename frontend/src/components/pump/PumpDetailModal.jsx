...
const PumpDetailModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div
        className={`w-full max-w-7xl max-h-[95vh] h-[95vh] flex flex-col ${
          isDarkMode ? "bg-gray-900" : "bg-white"
        } rounded-xl shadow-2xl overflow-hidden`}
      >
        {/* Header - Corporate Style */}
        <div className="bg-gradient-to-r from-slate-800 to-slate-700 text-white p-6 sticky top-0 z-40">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2">
                <button
                  ...
                  className="p-3 sm:p-2 rounded-lg hover:bg-white/10 transition-colors"
                  title="Upload Documentation"
                >
                  <PhotoIcon className="w-6 h-6 sm:w-5 sm:h-5 text-white" />
                </button>
                <button
                  onClick={() => onEdit(pump)}
                  className="p-3 sm:p-2 rounded-lg hover:bg-white/10 transition-colors"
                ...
                >
                  <PencilIcon className="w-6 h-6 sm:w-5 sm:h-5 text-white" />
                </button>
                <button
                  onClick={() => onDelete(pump.ccn_pump)}
                  disabled={isDeleting}
                  className="p-3 sm:p-2 rounded-lg hover:bg-red-500/20 transition-colors disabled:opacity-50"
                  title="Decommission Equipment"
                >
                  <TrashIcon className="w-6 h-6 sm:w-5 sm:h-5 text-red-300" />
                </button>
                <button
                  onClick={onClose}
                  className="p-3 sm:p-2 rounded-lg hover:bg-white/10 transition-colors"
                >
                  <XMarkIcon className="w-6 h-6 sm:w-5 sm:h-5 text-white" />
                </button>
              </div>
            </div>
          </div>
        ...
        {/* Tab Navigation */}
        <div className="border-b border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 sticky top-0 z-30">
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto overscroll-y-auto touch-pan-y">
