...
const Sidebar = () => {
	...
	return (
		<>
				...
				<div>
					...
					<ul>
						<li>
							...
							>
								<FcLinux className="text-primary" />
								Know me!!!
							</Link>
						</li>
						<li>
						...
						<li>
							...
							<ul className={` ${showSubmenu ? "h-[130px]" : "h-0"
			...
			<button onClick={() => setShowMenu(!showMenu)} className="xl:hidden fixed bottom-4 right-4 bg-primary2 text-black p-3 rounded-full z-50">
